...
class SecretsAPI(SecretsFixture):
    ...
    @tags(type='positive')
    def test_create_secret_w_only_payload_content_type(self):
    ...
    def test_create_secret_w_empty_secret(self):
        ...
        """
        self.assertRaises(
            ClientException, self.cl_behaviors.create_secret,
            payload_content_type=self.config.payload_content_type,
            payload='')

    @tags(type='negative')
    def test_create_secret_w_invalid_payload_content_type(self):
    ...
    def test_get_empty_raw_secret_by_href(self):
        ...
        self.assertRaises(
            ClientException, self.cl_client.get_raw_secret, href=resp.ref, 
            payload_content_type=self.config.payload_content_type)
    ...
    @tags(type='negative')
    def test_get_raw_secret_by_href_w_invalid_payload_content_type(self):
    ...
    @tags(type='negative')
    def test_get_raw_secret_by_id_w_invalid_payload_content_type(self):
